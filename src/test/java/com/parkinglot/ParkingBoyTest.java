...
public class ParkingBoyTest {
    ...
    @Test
    void should_throw_unrecognized_parking_ticket_exception_when_fetch_car_given_parking_boy_with_two_parking_lot_and_used_ticket() {
        //given
        ParkingLot firstParkingLot = new ParkingLot();
        ParkingLot secondParkingLot = new ParkingLot();
        List<ParkingLot> ParkingLotList= new ArrayList<>();
    ...
    @Test
    void should_throw_no_available_position_when_park_car_given_parking_boy_with_two_parking_full_parking_lot_and_car(){
        //given
        ParkingLot firstParkingLot = new ParkingLot(1);
